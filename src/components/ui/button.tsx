...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-accent-fill text-black hover:bg-accent/90 font-semibold shadow-lg shadow-accent/20',
        outline:
          'border border-hairline bg-transparent text-foreground hover:bg-surface hover:border-hairline',
        ghost: 'text-ink-strong hover:text-foreground hover:bg-surface',
