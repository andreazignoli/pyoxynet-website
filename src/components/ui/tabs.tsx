...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg bg-surface border border-hairline p-1 text-ink-body',
      className
    )}
    {...props}
  />
